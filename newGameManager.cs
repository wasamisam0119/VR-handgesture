...
public class newGameManager : MonoBehaviour
{
    ...
    {
        //task
        distanceTask = new Vector3[] { new Vector3(1f, 1.51f, 1.5f), new Vector3(0.84f, 0.865f, 1.15f) };
    ...
    void Update()
    {
        ...
        temp.text = "Location: " + controlObject.position.ToString();
        temp = GameObject.Find(2.ToString()).GetComponent<Text>();
        temp.text = "Rotation: " + controlObject.rotation.eulerAngles.ToString();
        temp = GameObject.Find(3.ToString()).GetComponent<Text>();
        temp.text = "Scale: " + controlObject.localScale.ToString();
        */
        /*
        temp = GameObject.Find(4.ToString()).GetComponent<Text>();
